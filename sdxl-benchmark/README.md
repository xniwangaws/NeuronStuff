...
| **Neuron trn2.3xlarge (whn09, SDK 2.29)** | **BF16 + NKI flash-attn + CFG=7.5** *(DataParallel[0,1], **2/4 cores = 1/2 芯片**, seeds 42-51)* | **11.14** | — | 10/10 | **$0.00346** | **0.34×(慢 2.90×)** | **0.75×**(便宜 25%） |
...
- **Neuron trn2.3xl (SDK 2.29) whn09 fork**: 11.14s 10/10,**whn09 只用 2/4 logical cores = 1/2 Trainium2 芯片**,按 1/2 芯片价 ($1.1175/hr) 计 $/image = **$0.00346**,**比 H100 BF16 便宜 25%** (whn09 扩展到 4 cores 预计再快 2× 追上 SDK 2.27)
...
| H100 BF16 | **Neuron BF16 CFG=7.5** | **Neuron whn09 NKI** | L4 BF16 |
|:---:|:---:|:---:|:---:|
...
4. **Neuron**:
   ...
   - **trn2.3xlarge (SDK 2.29) whn09 fork** (2/4 logical cores = 1/2 芯片): 11.14 s / 10/10 / **$0.00346 per image (比 H100 BF16 便宜 25%)**
