...
| L4 g6.4xlarge | **FP8(BFL 官方 ckpt)** | 77.25 | — | 13.12 GB | 10/10 | $0.02839 | 0.27×(慢 3.65×) | 1.12×(贵 12%) |
...
| L4 g6.4xlarge | **FP8(BFL 官方 ckpt)** | 388.66 | 17.48 GB | 10/10 | $0.1428 | 0.27×(慢 3.66×) | 1.12×(贵 12%) |
...
**L4 g6.4xlarge**:DLAMI PyTorch 2.7 / torch 2.8.0+cu128 / **BFL 官方 flux2 repo**(commit `50fe51627778`)+ 自写 FP8 Linear shim(`torch._scaled_mm`, per-tensor E4M3)/ ckpt = `black-forest-labs/FLUX.2-klein-9b-fp8`(guidance-distilled,4-step 原生,此处强制 50-step),Qwen3-8B-FP8 文本编码器分阶段加载避免 OOM,AE 转 BF16 以放进 2K decode(FP32 AE 在 2K 时中间特征图 4 GB 必 OOM)
...
1. **Neuron 2K 单图成本最低** — 比 L4 便宜 19% ($0.114 vs $0.141)
2. **Neuron 1K 便宜 14%** ($0.024 vs $0.028)，速度快 2.0×
3. **速度**: Neuron 快 2.0× (1K) / 2.1× (2K)
4. **L4 FP8 无成本优势**：1K 比 Neuron 贵 14%，2K 贵 19%
