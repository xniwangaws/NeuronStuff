...
| FLUX.2-klein | 9B | 25.9s / $0.016 (all-Neuron BF16) | 76.5s / $0.028 | **3.0× faster, 43% cheaper** | 184s / $0.114 (CPU TE/VAE) | 382.7s / $0.141 | **2.1× faster, 19% cheaper** |
