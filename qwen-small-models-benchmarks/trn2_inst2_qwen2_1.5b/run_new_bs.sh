#!/bin/bash
#
# Run new batch size configs enabled by NKI topk fix
# 4k_bs32, 4k_bs64, 8k_bs32 (both lnc1 and lnc2)
# All use unique cores/ports, can run parallel with 64k retry
#
set +e
...
TASKS=(
  "qwen2_1.5b_4k_bs32_tp1_lnc1"
  "qwen2_1.5b_4k_bs32_tp1_lnc2"
  "qwen2_1.5b_4k_bs64_tp1_lnc1"
  "qwen2_1.5b_4k_bs64_tp1_lnc2"
  "qwen2_1.5b_8k_bs32_tp1_lnc1"
  "qwen2_1.5b_8k_bs32_tp1_lnc2"
)

log ""
log "============================================"
log "NEW BS CONFIGS: ${#TASKS[@]} tasks (NKI topk fix applied)"
log "============================================"
...
log "Launched ${#pids[@]} tasks in parallel, waiting..."
...
log ""
log "============================================"
log "NEW BS COMPLETE: Success=$((${#pids[@]} - failed)) Failed=$failed"
log "============================================"
